...
let person1 = Human(name:"joanna" , age: 30)
let person2 = Human(name: "jolene", age: 25)
let person3 = Human(name: "joe", age: 34)
...
print("Please don't take my man")

}

let sortedPeople = [person1, person2, person3].sorted {$0 < $1}
print(sortedPeople)
